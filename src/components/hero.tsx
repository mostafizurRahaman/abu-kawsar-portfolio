  ...
  return (
    ...
    >
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-center justify-center relative h-96 order-1 md:order-2">
          {/* Main Avatar Circle */}
          ...
          {/* Download Button */}
          <div
            className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 flex gap-3 transition-all duration-1000 ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          >
            <button
